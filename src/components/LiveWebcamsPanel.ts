...
// Feed table lives in shared/live-channels-data.ts so the iOS bundle endpoint
// can serve the same registry (`server/` must not import `src/components/`).
import { WEBCAM_FEEDS, type WebcamFeed, type WebcamRegion } from '../../shared/live-channels-data';
